import { sortObjectArrayByStringKeyCollator } from "@mikezimm/fps-js/lib/logic/Arrays/sorting/objects";
...
import { fetchEasyPages, IItemsError } from '@mikezimm/fps-pnp2/lib/services/sp/pages/EasyPagesFetch'
import { createBasePerformanceInit, startPerformOp, updatePerformanceEnd } from '../../Performance';
// eslint-disable-next-line @typescript-eslint/no-unused-vars
import { ILoadPerformance, } from '../../Performance';
...
import { IHelpfullOutput } from "@mikezimm/fps-js/lib/logic/Errors/friendly";
...
export async function getPagesContent( sourceProps: ISourceProps, EasyIconObject: IEasyIcons = EasyIconObjectDefault, parentLink: string, ): Promise<IGetPagesContent> {
  ...
  const fetchResults: IItemsError = await fetchEasyPages( sourceProps, false, true );
