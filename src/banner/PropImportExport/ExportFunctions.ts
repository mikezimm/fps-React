...
import { indexOfAnyCase } from '@mikezimm/fps-js/lib/logic/Arrays/searching/objectfind';
   ...
   */
    ...
    * @returns 
    */
  export function createExportObject( exportStructure: IMinExportObject, thisProperties: any, ignoreProps: string[], skipNullUndefined: boolean = false ) {
    let finalObject:  any = {};
 ...
 * @returns 
 */
  export function createExportGroup( updateOnThese:string[], thisProperties: any, ignoreProps: string[], skipNullUndefined: boolean = false ) {
    let exportProps: any = { };
